...
class ReminderActivity : AppCompatActivity(){
    ...
    private fun getXML() {
        val b = intent.extras
        val dateTxt = findViewById<TextView>(R.id.reminder_date_txt)
        val diaryEdit = findViewById<EditText>(R.id.reminder_edit)
        mImageView = findViewById(R.id.reminder_imageView)
        ...
        val button = findViewById<Button>(R.id.reminder_close_btn)
        ...
        diaryEdit.setOnFocusChangeListener { _, f->
            if(f) {
                ...
                diaryEdit.hint = resources.getString(R.string.hint_remind)
            }
        }
        val sendBtn = findViewById<Button>(R.id.reminder_send_btn)
        sendBtn.setOnClickListener {view->
            val content = diaryEdit.text.toString()
            if(content!="")
                storeDiary(content)
            else {
                Snackbar.make(view, resources.getString(R.string.remind_blank), Snackbar.LENGTH_SHORT).show()
            }
        }
        val cameraBtn = findViewById<Button>(R.id.reminder_camera_btn)
        cameraBtn.setOnClickListener{
            getPermissions()
        }
        val galleryBtn = findViewById<Button>(R.id.reminder_gallery_btn)
    ...
    private fun createImageFile(): File {
        ...
        val timeStamp: String = SimpleDateFormat("yyyyMMdd_HH:mm:ss", Locale.TAIWAN).format(Date())
    ...
    private fun storeDiary(content:String) {
        ...
        editor.putString(date+"type"+id, "reminder")
        if(editor.commit()) {
            val i = Intent(this, MainActivity::class.java)
            val b = Bundle()
